...
#
# path_4 = '../DBN_results/loss/loss.pdf'
#
# #
...
# plt.legend([ 'RBM(100)', 'RBM(196)', 'RBM(400)'], loc='best', fontsize = 20)
...
ax1.set_xlabel('Number of epoches', fontsize = 20)
# Make the y-axis label, ticks and tick labels match the line color.
ax1.set_ylabel('Weight sparsity $\\rho$', color='b', fontsize=20)
...
saveName_sparsity = '../DBN_results/sparsity/weight_sparsity.pdf'
fig.tight_layout()
#plt.show()
