...
weight1 = '../DBN_results/activations/weights_199.npy'
bias1 = '../DBN_results/activations/bias_199.npy'
saveName = '../DBN_results/activations/196_filter.eps'
...
plt.ylabel('Number of hidden units', fontsize = 20)
plt.axis([-0.01, 0.61, 0, 70])
